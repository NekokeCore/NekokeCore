<div>
    ...
    <ul>
        ...
        <li>⚡ Fun Fact: NULL</li>
        <li>🔗 Blog: <a herf="">https://www.emtips.net</a> , <a herf="https://www.poii.tech/">https://www.1tip.cc</a></li>
        <li>🔑 GPG Key: https://github.com/NekokeCore.gpg , Use ```curl https://github.com/NekokeCore.gpg | gpg --import``` to import my key</li>
    </ul>
